...
- (void)keyboardWillShow:(NSNotification *)aNotification
{
    ...
    if (self.textView.text.length == 0) {
        self.backGroundView.frame = CGRectMake(0, self.superview.bounds.size.height-height-49, kScreenwidth, 49);
        if (self.popupType == 1) {
            self.backGroundView.frame = CGRectMake(0, 500-height-49, kScreenwidth, 49);
        }
    }else{
